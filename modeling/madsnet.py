...
class MADSNet(nn.Module):
    ...
    def forward(self, x):
        ...
        ##########################
        down4 = F.interpolate(self.down4(d4), size=d2.size()[2:], mode='bilinear')
        down3 = F.interpolate(self.down3(d3), size=d2.size()[2:], mode='bilinear')
        down2 = self.down2(d2)
        ...
        refine4 = F.interpolate(refine4, size=x_.size()[2:], mode='bilinear')
        refine3 = F.interpolate(refine3, size=x_.size()[2:], mode='bilinear')
        refine2 = F.interpolate(refine2, size=x_.size()[2:], mode='bilinear')
        refine1 = F.interpolate(refine1, size=x_.size()[2:], mode='bilinear')
